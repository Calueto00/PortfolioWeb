                    ...
                    <div className="flex  justify-between gap-8">
                        ...
                        <div className="rounded-lg flex-1">
                            <div className=" w-full p-2 border-b-1 space-y-1 border-gray-600">
                                <h4 className="text-slate-200">Location</h4>
                                <p className="text-slate-400">Camama, Luanda, Angola</p>
                            </div>
                            <div className="p-2 w-full border-b-1 space-y-1 border-gray-600">
                                <h4 className="text-slate-200">Phone Number</h4>
                                <p className="text-slate-400">+244 937163467</p>
                            </div>
                            <div className="p-2 w-full space-y-1 border-gray-600">
                                <h4 className="text-slate-200">Email Address</h4>
                                <p className="text-slate-400">paulo.calueto.francisco@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
