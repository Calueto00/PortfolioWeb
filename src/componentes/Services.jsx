    ...
    return (
        <section id="services" className="md:h-screen bg-zinc-950">
            <div className="lg:max-w-6xl mx-auto h-full flex flex-col justify-center p-6 md:px-4">
                ...
                <div className="grid md:gap-6 gap-4 md:grid-cols-3 md:mt-12 mt-8">
                    {services.map(service => (
                        <div
                            key={service.title}
                            className="border border-zinc-800 bg-zinc-900 md:p-6 p-4 rounded-3xl shadow-md shadow-black/30 hover:-translate-y-1 transition-transform duration-300"
                        >
